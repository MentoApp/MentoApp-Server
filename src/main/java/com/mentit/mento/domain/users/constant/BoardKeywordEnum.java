...
public enum BoardKeywordEnum {
    ...
    BoardKeywordEnum(String koreanValue) {
        this.koreanValue = koreanValue;
    }

    public static BoardKeywordEnum fromKoreanValue(String koreanValue) {
        for (BoardKeywordEnum keyword : values()) {
