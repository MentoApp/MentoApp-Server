...
public enum MyCareerTagsEnum {
    ...
    MyCareerTagsEnum(String description) {
        this.description = description;
    }

    public static MyCareerTagsEnum fromDescription(String description) {
        for (MyCareerTagsEnum career : values()) {
