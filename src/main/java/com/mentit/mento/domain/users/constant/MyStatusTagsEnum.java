...
public enum MyStatusTagsEnum {
    ...
    MyStatusTagsEnum(String description) {
        this.description = description;
    }

    public static MyStatusTagsEnum fromDescription(String description) {
        for (MyStatusTagsEnum status : values()) {
